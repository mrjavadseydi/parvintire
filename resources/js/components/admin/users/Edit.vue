            ...
            <div class="row">
                ...
                <div class="col-md-6 pl-3 pl-md-0 my-3 my-md-0">
                    <form id="user-form" class="card" @submit.prevent="onSubmitUser" @change="keydown" @keydown="keydown">
                        ...
                        <div class="card-body no-scroll md-scroll">
                            <div class="row">
...
<script>
    ...
    import DateGroup from "../../forms/group/DateGroup";
    ...
    import TextAreaInputGroup from "../../forms/group/TextAreaInputGroup";
    import PriceInputGroup from "../../forms/group/PriceInputGroup";
    import LocationGroup from "../../forms/group/LocationGroup";

...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-3">
            <input type="hidden" name="loading" value="{{ asset('/images/default/loading.png') }}">
            <div class="box box-widget widget-user">
                <div class="widget-user-header bg-aqua-active tar" style="background-image: url('{{ asset('/images/default/auth-box.jpg') }}')">

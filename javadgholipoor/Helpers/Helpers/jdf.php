...
/*	F	*/
function jDateTime($format,$timestamp='',$none='',$time_zone='Asia/Tehran',$tr_num='fa'){
        ...
        if($m===''){
            ...
            if($s===''){
                ...
                if($jm===''){
                    ...
                    $jdate=explode('_',jDateTime('Y_j','','',$timezone,'en'));
                    if($jd===''){
...
function jalali_to_gregorian($jy,$jm,$jd,$mod=''){
    ...
    return($mod==='')?array($gy,$gm,$gd):rePairDate($gy .$mod .$gm .$mod .$gd, $mod);
}
